...
os.makedirs("results/fb_cache_results", exist_ok=True)
...
for th in threshold_values:
    with FBTransformerCacheContext() as fb_ctx:
        ...
        out_path_1 = f"results/fb_cache_results/flux_t{th*100}_first.png"
        out_path_2 = f"results/fb_cache_results/flux_t{th*100}_second.png"
