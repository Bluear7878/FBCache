...
threshold_values = [0, 0.01, 0.05, 0.1, 0.2, 0.5, 0.8]  

num_inference_steps = 50
guidance_scale = 3.5
prompt = "A cute panda holding a sign that says hello world"

os.makedirs("fb_cache_results", exist_ok=True)

for th in threshold_values:
    with FBTransformerCacheContext() as fb_ctx:
        transformer.set_residual_diff_threshold(th)
        ...
        out_path_1 = f"fb_cache_results/flux_t{th}_first.png"
        out_path_2 = f"fb_cache_results/flux_t{th}_second.png"
